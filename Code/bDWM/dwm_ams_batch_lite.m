function[acc, avg_acc , result, preds, avg_acc_test, pred_test, ams, times] = dwm_ams_batch_lite(data, labels, classifier, mode, flag_rc,  batchsize, test_data, test_labels, folds)
