function[acc, avg_acc , result, preds, avg_acc_test, pred_test, ams, time] = dwm_ams_batch_lite_ph2(data, labels, classifier, mode, flag_rc,  batchsize, test_data, test_labels, folds)
tic
