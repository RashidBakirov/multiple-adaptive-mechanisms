function[acc, avg_acc , result, preds, avg_acc_test, pred_test, ams, times] = dwm_ams_batch_lite2_xvpar(data, labels, classifier, mode, flag_rc,  batchsize, test_data, test_labels, folds)
...
%time109=time109+toc;
    ...
    if flag_rc
        ...
        %tic
        for i=1:2
            ensemble{i}=dwm_adapt_batch_lite2(selected_ensemble,dsk,classifier,i);
        end
        %time185=time185+toc;
    ...
    elseif mode~=11 %if not set selected_ensemble auomatically
      ...
      elseif mode==9 %original dwm
        ...
        selected_ensemble=dwm_adapt_batch_lite2(selected_ensemble,dsk,classifier,r);       
    end
