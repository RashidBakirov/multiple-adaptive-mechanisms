function[acc, avg_acc , result, preds, avg_acc_test, pred_test, ams, time] = dwm_ams_batch_lite_ph(data, labels, classifier, mode, flag_rc,  batchsize, test_data, test_labels, folds)
tic
...
if flag_rc
    ...
    selected_ensemble{2}.model=cl1;
    selected_ensemble{2}.weight=1;
    selected_ensemble{2}.data=ds1;
end
